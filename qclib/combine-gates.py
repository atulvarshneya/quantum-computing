...
qc.qgate(H4,[7,5,3,1], display=True)
qc.qgate(C4,[7,6,5,4,3,2,1,0], display=True)
qc.qgate(qc.C(),[7,6])
qc.qgate(qc.C(),[5,4])
qc.qgate(qc.C(),[3,2])
qc.qgate(qc.C(),[1,0])
...
qc.qgate(HXYZ,[0],display=True)
qc.qgate(qc.Z(),[0],display=True)
qc.qgate(qc.Y(),[0],display=True)
qc.qgate(qc.X(),[0],display=True)
qc.qgate(qc.H(),[0],display=True)
