...
print('test 01 - NISQdeb, All KrausOperatorSequence')
ck = qckt.QCkt(3,3)
ck.X([0])
...
print('test 02 - NISQdeb, All KrausOperatorSequence')
ck = qckt.QCkt(3,3)
ck.X([0])
...
print('test 03 - NISQeng, All KrausOperatorSequence')
ck = qckt.QCkt(3,3)
ck.X([0])
ck.NOISE(kraus_ops=ns.KrausOperatorSequence(ns.bit_flip(probability=0.1)),qbit=[0,1,2])
ck.CX(0,1)
...
print('test 04 - NISQeng, All KrausOperatorSequence')
ck = qckt.QCkt(3,3)
ck.X([0])
ck.NOISE(kraus_ops=ns.bit_flip(probability=0.1),qbit=[0,1,2])
ck.CX(0,1)
